# AuraConv-GLM- Real‑Time Convolution Filter & Audio Playground
...
### ✂️ Block Processing (Variable‑Length Gate)
- **Block Samples** – Set any block length from **1 sample** (Nyquist‑rate chopping) up to **100 000 samples** (≈2.3 s at 44.1 kHz).
...
### 🖥️ User Interface & Visualisation
...
2. Open index.html in a modern browser (Chrome, Firefox, Edge, Safari).
   ⚠️ Microphone access requires a secure context (HTTPS or localhost).
